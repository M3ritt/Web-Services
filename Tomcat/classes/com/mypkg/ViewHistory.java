...
public class ViewHistory extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try (
			...
			String sqlStr = "select history.bread, history.meat, history.cheese, history.sauce, history.veggies, history.extras from history where history.username = '" + lastbit + "'";
